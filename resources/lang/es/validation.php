...
return [
    ...
    | la clase de validador. Algunas de estas reglas tienen varias versiones como las reglas
    | de tamaño. Siéntete libre de modificar cada uno de estos mensajes aquí.
    |
    */
    ...
    | convención "atributo.regla" para nombrar las claves. Esto hace que sea
    | rápido especificar un mensaje personalizado para una regla dada a un
    | atributo particular.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí puedes especificar nombres personalizados para los atributos de
    | tus campos para que los mensajes de error sean más claros para el usuario.
    |
    */
